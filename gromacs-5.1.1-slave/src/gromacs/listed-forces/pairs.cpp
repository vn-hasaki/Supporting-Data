                ...
                real qq, real c6, real c12, real *velec, real *vvdw)
{
    ...
    *velec           = qq*VVe;
    *vvdw            = c6*VVd+c12*VVr;
    // printf("---------------------------evaluate_single: qq = %.10f, FFe = %.10f, c6 = %.10f, FFd = %.10f, c12 = %.10f, FFr = %.10f, tabscale = %.10f, rinv = %.10f------------------------------\n", qq, FFe, c6, FFd, c12, FFr, tabscale, rinv);
    // fscal            = -(qq*(-0.028)+c6*FFd+0.000001*FFr)*1750.0;
    //fscal            = -(qq*FFe+c6*FFd+c12*FFr)*tabscale*rinv;
    fscal            = 0.0;
    // printf("---------------------------evaluate_single: fscal = %.20f------------------------------\n", fscal);
